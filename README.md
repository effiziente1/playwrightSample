...
EFFIZIENTE_API_URL='https://abi-testing-dojo-auth-demo.azurewebsites.net'
EFFIZIENTE_URL='https://abi-testing-dojo-demo.azurewebsites.net'
EFFIZIENTE_COMPANY='Northwind'
EFFIZIENTE_NORMAL_USER='janedoe'
EFFIZIENTE_NORMAL_PASSWORD='User+123'
EFFIZIENTE_ADMIN_USER='jdoe'
EFFIZIENTE_ADMIN_PASSWORD='Admin+123'
